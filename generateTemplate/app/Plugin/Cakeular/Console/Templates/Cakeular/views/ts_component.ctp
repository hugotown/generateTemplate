...
@Component({
  selector: 'app-<?= $pluralVar; ?>',
  templateUrl: './<?= $pluralVar; ?>.component.html',
  styleUrls: ['./<?= $pluralVar; ?>.component.css']
})
export class <?= Inflector::pluralize( $pluralHumanName ); ?>Component implements OnInit
{
