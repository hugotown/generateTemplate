...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group" ng-class="{ 'has-error' : submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid }">
            <label for="<?= $field;?>" class="col-lg-4 col-md-4 col-sm-4 control-label">{{ '<?= $field;?>' | translate }}</label>
            <div class="col-lg-8 col-md-8 col-sm-8">
                <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $singularVar; ?>.<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-date-format="yyyy-MM-dd" data-model-date-format="yyyy-MM-dd HH:mm:ss" data-date-type="string" data-container="body" data-autoclose="1" data-animation="am-fade" bs-datepicker >
                <span ng-show="submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid" class="help-block">
                  <p ng-show="<?= $singularVar; ?>Form.<?= $field;?>.$error.required">
                      {{ '<?= $field;?> field is required' | translate }}
                  </p>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group" ng-class="{ 'has-error' : submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid }">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $singularVar; ?>.<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-date-format="yyyy-MM-dd" data-model-date-format="yyyy-MM-dd HH:mm:ss" data-date-type="string" data-container="body" data-autoclose="1" data-animation="am-fade" bs-datepicker >
                <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $singularVar; ?>.<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-model-time-format="yyyy-MM-dd HH:mm:ss" data-time-type="string" data-container="body" data-autoclose="1" data-animation="am-fade" bs-timepicker >
                <span ng-show="submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid" class="help-block">
                  <p ng-show="<?= $singularVar; ?>Form.<?= $field;?>.$error.required">
                      {{ '<?= $field;?> field is required' | translate }}
                  </p>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-md-12 col-xs-12">
                                        ...
                                        <a ui-sref="<?php echo $pluralVar; ?>List" ng-disabled="!session.acl.<?php echo $pluralVar; ?>.getAction" class="btn default {{(!session.acl.<?php echo $pluralVar; ?>.getAction) ? 'disabled' : ''}}">{{ 'Cancel' | translate }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
