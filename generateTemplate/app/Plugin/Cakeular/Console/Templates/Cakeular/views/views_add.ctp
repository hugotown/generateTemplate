                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group" ng-class="{ 'has-error' : submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid }">
                                                        <label for="<?= $field;?>" class="col-lg-4 col-md-4 col-sm-4 control-label">{{ '<?= $singularVar . '-' . $field;?>' | translate }}</label>
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> >
                                                            <span ng-show="submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid" class="help-block">
                                                              <p ng-show="<?= $singularVar; ?>Form.<?= $field;?>.$error.required">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group" ng-class="{ 'has-error' : submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid }">
                                                        <label for="<?= $field;?>" class="col-lg-4 col-md-4 col-sm-4 control-label">{{ '<?= $singularVar . '-' . $field;?>' | translate }}</label>
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <textarea name="<?= $field;?>" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> ></textarea>
                                                            <span ng-show="submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid" class="help-block">
                                                              <p ng-show="<?= $singularVar; ?>Form.<?= $field;?>.$error.required">
                                                                  {{ '<?= $field;?> field is required' | translate }}
                                                              </p>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-group" ng-class="{ 'has-error' : submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid }">
                                                        <label for="<?= $field;?>" class="col-lg-4 col-md-4 col-sm-4 control-label">{{ '<?= $singularVar . '-' . $field;?>' | translate }}</label>
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <input name="<?= $field;?>" type="number" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> ignore-mouse-wheel >
                                                            <span ng-show="submitted && <?= $singularVar; ?>Form.<?= $field;?>.$invalid" class="help-block">
                                                              <p ng-show="<?= $singularVar; ?>Form.<?= $field;?>.$error.required">
                                                                  {{ '<?= $field;?> field is required' | translate }}
                                                              </p>
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12" >
                                                                    <div class="input-group">
                                                                        <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-date-format="yyyy-MM-dd" data-model-date-format="yyyy-MM-dd" data-date-type="string" data-container="body" data-autoclose="1" data-animation="am-flip-x" bs-datepicker >
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6" >
                                                                    <div class="input-group">
                                                                        <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-date-format="yyyy-MM-dd" data-model-date-format="yyyy-MM-dd HH:mm:ss" data-date-type="string" data-container="body" data-autoclose="1" data-animation="am-flip-x" bs-datepicker >
                                                                        <div class="input-group-btn">
                                                                            <label for="<?= $field;?>" class="btn btn-default">
                                                                                <i class=" glyphicon glyphicon-calendar" ></i>
                                                                            </label>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6" >
                                                                    <div class="input-group">
                                                                        <input name="<?= $field;?>" type="text" class="form-control" ng-model="<?= $field;?>" id="<?= $field;?>-Time" placeholder="{{ '<?= $singularVar . '-' . $field;?>' | translate }}" autocomplete="off" <?= $required ; ?> data-model-time-format="yyyy-MM-dd HH:mm:ss" data-time-type="string" data-container="body" data-autoclose="1" data-animation="am-flip-x" bs-timepicker >
                                                                        <div class="input-group-btn">
