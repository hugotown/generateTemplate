...
<?php echo $this->Form->create('Workarea'); ?>
	<fieldset>
		<legend><?php echo __('Edit Workarea'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Workarea.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Workarea.id'))); ?></li>
