      ...
      return {
        ...
        controller: ['$rootScope','$scope', '$element', '$attrs', function ($rootScope, $scope, $element, $attrs) {
          ...
          function fixHeaderWidths() {
            ...
            if ($element.find("thead th:not(:has(.th-inner))").length) {
              $element.find("thead th:not(:has(.th-inner))").wrapInner('<div class="th-inner"></div>');
            }            
            ...
            //console.log("fixHeaderWidths", $element.find("thead th"));
          ...
          $rootScope.$on("renderScrollableTable", function() {
            //console.log("renderScrollableTable");
            renderChains($element.find('.scrollArea').width());
          });
