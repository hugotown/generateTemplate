...
angular.module('dndLists', [])
   ...
   */
  .directive('dndList', ['$window','$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
                 function($window, $parse,   $timeout,   dndDropEffectWorkaround,   dndDragTypeWorkaround) {
    return function(scope, element, attr) {
      ...
      element.on('dragover', function(event) {
        ...
        if (placeholderNode.parentNode != listNode) {
          ...
          el = $('li.dndPlaceholder');
          /*console.log($window.innerHeight);
          console.log(placeholderNode.parentNode);
