...
angular.module('mgcrea.ngStrap.alert').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('alert/alert.tpl.html', '<li class="notyfy_wrapper" ng-class="[type ? \'notyfy_\' + type : null]"><button type="button" class="close" ng-if="dismissable" ng-click="$hide()">&times;</button> <strong ng-bind="title"></strong>&nbsp;<span class="notyfy_text" ng-bind-html="content"></span></li>');
}]);
